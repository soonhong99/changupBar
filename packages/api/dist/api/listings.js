...
router.post('/:id/like', authMiddleware, asyncHandler(listingController.likeListing));
...
router.delete('/:id', authMiddleware, asyncHandler(listingController.deleteListing));
// PATCH /api/v1/listings/:id - 특정 매물 수정 (로그인 필요)
router.patch('/:id', authMiddleware, asyncHandler(listingController.updateListing));
