...
export const faqData = [
  {
    ...
    questions: [
      {
        q: "창업절차는 어떻게 되나요?",
        a: "① 전화 및 문자상담 → ② 아이템 선정 → ③ 내방상담 혹은 현장미팅 → ④ 매장 계약의 순서로 진행됩니다. 각 단계별로 전문 컨설턴트가 함께합니다."
      },
      {
  ...
  },
  {
    ...
    questions: [
      {
        q: "제가 ~일을 했었는데 창업을 시작해도 괜찮을까요?",
        a: "사업은 엄청나게 대단한 사람이 하는 것이 아닙니다. 그저 '노력'만 하시면 원하는 바를 얻어가실 수 있습니다. 물론 그 노력의 양은 상상을 초월합니다. 하지만 남들이 18년 걸려서 얻는 수익을 9년, 4년으로 획기적으로 단축시킬 수 있는 수단이자 방법입니다. 가장 빠르게 경제적 자유의 길로 안착할 수 있는 통로입니다. 먼저 자기 자신에게 질문을 해주세요. 남들이 가지 않는 방향으로 도전할 확신이 생겼는지. 어떤 누구가 오셔도 원하는 바를 얻어가실 수 있도록 최선을 다하겠습니다."
      },
      {
