            ...
            <div className="flex items-center space-x-2 text-lg">
              {(() => {
                const features = [
                  ...
                  { 
                    condition: listing.isGoodDeal, 
                    element: (
                      <span key="good" title="알짜 매장" className="inline-flex items-center gap-1 px-2.5 py-1.5 bg-emerald-50 dark:bg-emerald-950 border border-emerald-200 dark:border-emerald-800 text-emerald-700 dark:text-emerald-300 rounded-lg text-xs font-semibold shadow-sm">
                        💎 알짜
                      </span>
                    )
                  },
                  ...
                  { 
                    condition: listing.isSpecialDistrict, 
                    element: (
                      <span key="special" title="특수상권" className="inline-flex items-center gap-1 px-2.5 py-1.5 bg-orange-50 dark:bg-orange-950 border border-orange-200 dark:border-orange-800 text-orange-700 dark:text-orange-300 rounded-lg text-xs font-semibold shadow-sm">
                        🎯 특수
                      </span>
                    )
                  }
